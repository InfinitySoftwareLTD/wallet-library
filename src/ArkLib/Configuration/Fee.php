...
namespace InfinitySolution\Wallet\ArkLib\Configuration;

use InfinitySolution\Wallet\ArkLib\Enums\Fees;
use InfinitySolution\Wallet\ArkLib\Enums\Types;
...
class Fee
{
     ...
     * @param string $fee
     */
    public static function set(int $type, string $fee)
    {
