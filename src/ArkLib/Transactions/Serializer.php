...
namespace InfinitySolution\Wallet\ArkLib\Transactions;

use InfinitySolution\Wallet\ArkLib\Configuration\Network;
use InfinitySolution\Wallet\ArkLib\Enums\TypeGroup;
use InfinitySolution\Wallet\ArkLib\Transactions\Types\Transaction;
...
class Serializer
{
     ...
     *
     * @param \InfinitySolution\Wallet\ArkLib\Transactions\Types\Transaction $transaction
     */
    ...
    private function serializeCommon(ByteBuffer $buffer)
    {
    ...
    private function serializeVendorField(ByteBuffer $buffer)
    {
     ...
     * @return string
     */
    public function serializeSignatures(ByteBuffer $buffer, array $options)
    {
