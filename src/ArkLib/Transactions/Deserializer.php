...
class Deserializer
{
    ...
    private function deserializeCommon(array &$data)
    {
        $this->buffer->skip(1);
    ...
    private function deserializeVendorField(Transaction $transaction)
    {
    ...
    private function deserializeSignatures(array &$data)
    {
        $this->deserializeSchnorrOrECDSA($data);
    }

    private function deserializeSchnorrOrECDSA(array &$data)
    {
    ...
    private function deserializeSchnorr(array &$data)
    {
    ...
    private function deserializeECDSA(array &$data)
    {
        // Signature
        if ($this->buffer->remaining()) {
