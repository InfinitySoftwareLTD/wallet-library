...
use InfinitySolution\Wallet\ArkLib\Transactions\Types\Transfer;
...
class TransferBuilder extends AbstractTransactionBuilder
{
    ...
    {
        return \InfinitySolution\Wallet\ArkLib\Enums\Types::TRANSFER;
    }
    ...
    protected function getTransactionInstance(): Transfer
    {
        return new Transfer();
    }
}
