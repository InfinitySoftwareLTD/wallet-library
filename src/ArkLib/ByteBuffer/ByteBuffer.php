...
namespace InfinitySolution\Wallet\ArkLib\ByteBuffer;
...
class ByteBuffer
{
     ...
     * @param array|string|int $value
     *
     * @return \InfinitySolution\Wallet\ArkLib\ByteBuffer\ByteBuffer
     */
     ...
     */
    public function initializeBuffer(int $length, $content)
    {
        for ($i = 0; $i < $length; $i++) {
     ...
     *
     * @param \InfinitySolution\Wallet\ArkLib\ByteBuffer\ByteBuffer $buffer
     * @param int                               $offset
     *
     * @return \InfinitySolution\Wallet\ArkLib\ByteBuffer\ByteBuffer
     */
